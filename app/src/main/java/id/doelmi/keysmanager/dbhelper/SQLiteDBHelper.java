...
public class SQLiteDBHelper extends SQLiteOpenHelper {
    ...
    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 1) {
            String SQL = "CREATE TABLE KUNCI (_id INTEGER PRIMARY KEY AUTOINCREMENT, NAMA_KUNCI TEXT, DESKRIPSI_KUNCI TEXT, GAMBAR_KUNCI INTEGER, GAMBAR_KUNCI_URI TEXT, STATUS INTEGER, DIBAWA_OLEH TEXT, WAKTU TEXT, TANGGAL DATE, DIARSIPKAN INTEGER);";
            db.execSQL(SQL);
            SQL = "CREATE TABLE PENGAMBILAN_KUNCI (_id INTEGER PRIMARY KEY AUTOINCREMENT, NAMA_PENGAMBIL_KUNCI TEXT, NO_ID_PENGAMBIL TEXT, NAMA_KUNCI_AMBIL TEXT, TANGGAL_AMBIL DATE, WAKTU_AMBIL TEXT, ID_LOG INTEGER);";
            db.execSQL(SQL);
            SQL = "CREATE TABLE PENGEMBALIAN_KUNCI (_id INTEGER PRIMARY KEY AUTOINCREMENT, NAMA_PENGEMBALI_KUNCI TEXT, NO_ID_PENGEMBALI TEXT, NAMA_KUNCI_KEMBALI TEXT, TANGGAL_KEMBALI DATE, WAKTU_KEMBALI TEXT, ID_LOG INTEGER);";
            db.execSQL(SQL);
            SQL = "CREATE TABLE LOG_AKTIVITAS (_id INTEGER PRIMARY KEY AUTOINCREMENT, AKTIVITAS TEXT, WAKTU TEXT, KUNCI TEXT);";
            db.execSQL(SQL);
